...
SYSTEM_TABLES = {
  ...
  'chip_model': {
    ...
    'fields': [
      {'name': 'name', 'display': '名称', 'required': True, 'unique': True},
      {'name': 'interface_ids', 'display': '接口', 'required': False, 'ref': 'chip_interface', 'is_multi': True}
    ]
  },
  'locomotive_series': {
    'display_name': '机车系列',
  ...
  'light_model': {
    ...
    'fields': [
      {'name': 'name', 'display': '名称', 'required': True},
      {'name': 'color_temperature', 'display': '色温', 'required': True},
      {'name': 'light_brand_id', 'display': '灯品牌', 'required': True, 'ref': 'light_brand'}
    ]
  },
  ...
  'carriage': {
    ...
    'fields': [
      ...
      {'name': 'light_model_id', 'display': '灯光型号', 'required': False, 'is_item_field': True, 'ref': 'light_model'}
    ]
  },
  'trainset': {
    'display_name': '动车组模型',
    ...
    'fields': [
      ...
      {'name': 'light_model_id', 'display': '室内灯', 'required': False, 'ref': 'light_model'},
      {'name': 'chip_interface_id', 'display': '芯片接口', 'required': False, 'ref': 'chip_interface'},
      {'name': 'chip_model_id', 'display': '芯片型号', 'required': False, 'ref': 'chip_model'},
      {'name': 'price', 'display': '价格', 'required': False},
      {'name': 'item_number', 'display': '货号', 'required': False},
