...
def update_locomotive_from_form(locomotive, form_data):
  ...
  locomotive.product_url = form_data.get('product_url')
...
def api_edit_locomotive(id):
  ...
  try:
    ...
    handle_folder_rename('locomotive', id, old_brand, old_item_number,
                         new_brand, locomotive.item_number or '')
...
def delete_locomotive(id):
  ...
  try:
    ...
    delete_model_files('locomotive', id)
