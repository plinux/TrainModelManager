...
def update_trainset_from_form(trainset, form_data):
  ...
  trainset.light_model_id = safe_int(form_data.get('light_model_id'))
...
def api_edit_trainset(id):
  ...
  try:
    ...
    handle_folder_rename('trainset', id, old_brand, old_item_number,
                         new_brand, trainset.item_number or '')
...
def delete_trainset(id):
  ...
  try:
    ...
    delete_model_files('trainset', id)
